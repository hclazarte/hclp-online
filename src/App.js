...
const App = () => {
  ...
  return (
    <Router>
      <Routes>
        <Route path="/" element={autenticado ? <Navigate to="/app/afiliados" /> : <Ingreso setAutenticado={setAutenticado} />} />
        <Route path="/app" element={<Principal setAutenticado={setAutenticado}/>}>
