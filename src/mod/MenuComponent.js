  ...
  return (
    <nav className='bg-inf3 p-2 relative border border-inf4 rounded-lg rounded-lg'>
      <div className='flex items-center justify-between'>
        ...
        {/* Título centrado */}
        <h1 className='text-xl font-bold text-inf6'>{titulo}</h1>
        ...
        >
          ...
          >
            <path
              d='M13.1077 17.5385H10.8C10.4308 17.5385 10.1538 17.2615 10.1538 16.8923V16.2C10.1538 14.2615 11.4 12.5077 13.2461 11.8615C13.8 11.6769 14.3077 11.3538 14.7231 10.8923C17.0308 8.12308 14.9077 4.8 12.1385 4.70769C11.1231 4.66154 10.1538 5.03077 9.41538 5.72308C8.81538 6.27692 8.44615 6.96923 8.35384 7.75385C8.30769 8.03077 8.03076 8.26154 7.66153 8.26154H5.35384C4.93846 8.26154 4.61538 7.93846 4.66153 7.52308C4.84615 5.76923 5.63076 4.2 6.87692 2.95385C8.35384 1.56923 10.2461 0.830769 12.2769 0.876923C16.1077 1.01538 19.2461 4.15385 19.3846 7.98461C19.5231 11.2154 17.5385 14.1231 14.5385 15.2308C14.1231 15.4154 13.8461 15.7385 13.8461 16.1538V16.8462C13.8461 17.2615 13.4769 17.5385 13.1077 17.5385Z'
              fill='#4776d3'
            />
            <path
              d='M13.8461 22.3846C13.8461 22.7538 13.5231 23.0769 13.1538 23.0769H10.8461C10.4769 23.0769 10.1538 22.7538 10.1538 22.3846V20.0769C10.1538 19.7077 10.4769 19.3846 10.8461 19.3846H13.1538C13.5231 19.3846 13.8461 19.7077 13.8461 20.0769V22.3846Z'
              fill='#4776d3'
            />
          </svg>
        </button>
