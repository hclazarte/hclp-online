  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-inf2">
      <div className="w-full max-w-md bg-inf2 p-8">
        <h2 className="text-inf6 text-3xl font-bold text-center mb-6">Iniciar</h2>
        ...
        <p className="text-inf6 text-center mt-4 cursor-pointer hover:underline">Olvidó su contraseña</p>
      </div>
    </div>
  );
};
