const AyudaComponent = ({ setIsAyuda }) => {
  return (
    <div className='fixed top-2 left-1/2 transform -translate-x-1/2 w-80 bg-inf1 border border-inf4 rounded-lg shadow-md p-4 z-20'>
