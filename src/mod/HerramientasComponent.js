    ...
    <div className="bg-inf2 border border-inf4 rounded-lg shadow-md p-4 flex flex-col gap-4"> 
      ...
      <div className="flex flex-wrap gap-1 p-1 bg-inf1 rounded-md">
        <div className="flex gap-1">
          ...
          <button onClick={() => manejarClick("editar")} className={`p-1 rounded ${esHabilitado("editar") ? "bg-inf4 text-white" : "bg-inf3 opacity-50 cursor-not-allowed"}`}>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="36" rx="5" fill="#527dd6" />
          ...
          <button onClick={() => manejarClick("borrar")} className={`p-1 rounded ${esHabilitado("borrar") ? "bg-inf4 text-white" : "bg-inf3 opacity-50 cursor-not-allowed"}`}>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="36" rx="5" fill="#527dd6" />
          ...
          <button onClick={() => manejarClick("grabar")} className={`p-1 rounded ${esHabilitado("grabar") ? "bg-inf4 text-white" : "bg-inf3 opacity-50 cursor-not-allowed"}`}>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="36" rx="5" fill="#527dd6" />
          ...
          <button onClick={() => manejarClick("cancelar")} className={`p-1 rounded ${esHabilitado("cancelar") ? "bg-inf4 text-white" : "bg-inf3 opacity-50 cursor-not-allowed"}`}>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="36" rx="5" fill="#527dd6" />
          ...
          <button onClick={() => manejarClick("limpiar")} className={`p-1 rounded ${esHabilitado("limpiar") ? "bg-inf4 text-white" : "bg-inf3 opacity-50 cursor-not-allowed"}`}>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="36" rx="5" fill="#527dd6" />
          ...
          <button onClick={() => manejarClick("consultar")} className={`p-1 rounded ${esHabilitado("consultar") ? "bg-inf4 text-white" : "bg-inf3 opacity-50 cursor-not-allowed"}`}>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="36" rx="5" fill="#527dd6" />
        ...
        <div className="flex gap-1">
          ...
          <button className={`p-1 rounded ${esHabilitado("anterior") ? "bg-inf4 text-white" : "bg-inf3 opacity-50 cursor-not-allowed"}`}>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="36" rx="5" fill="#527dd6" />
              <path d="M28 8V28L8 18L28 8Z" fill="white" stroke="#777777" stroke-width="0.24" />
            </svg>
          </button>
          <div className="p-2 border border-inf4 rounded flex justify-center items-center" style={{ width: "140px" }}>
            <span className="text-center">10/100</span>
          </div>
          <button className={`p-1 rounded ${esHabilitado("siguiente") ? "bg-inf4 text-white" : "bg-inf3 opacity-50 cursor-not-allowed"}`}>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="36" rx="5" fill="#527dd6" />
              <path d="M8 28V8L28 18L8 28Z" fill="white" stroke="#777777" stroke-width="0.24" />
            </svg>
          </button>
          <button className={`p-1 rounded ${esHabilitado("ultimo") ? "bg-inf4 text-white" : "bg-inf3 opacity-50 cursor-not-allowed"}`}>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="36" rx="5" fill="#527dd6" />
